...
var o=e(t,i)
return o},e})},{}],72:[function(e,t,n){var r=e("js-yaml")
t.exports=function(e,t){t=t||"__content"
var n,i=/^(-{3}(?:\n|\r)([\w\W]+?)(?:\n|\r)-{3})?([\w\W]*)*/,o=i.exec(e),s={}
return(n=o[2])&&(s="{"===n.charAt(0)?JSON.parse(n):r.load(n)),s[t]=o[3]?o[3]:"",s}},{"js-yaml":73}],73:[function(e,t,n){"use strict"
